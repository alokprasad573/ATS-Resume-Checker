...
from server.models.schemas import AnalysisResponse, ComponentScores, JDComparison, SkillValidationDetails
...
async def analyze_resume(
    ...
    try:
        from server.services.resume_analyzer import analyze_full_resume
    ...
    from server.models.schemas import ComponentScores
    ...
    try:
        from server.database.db import save_analysis
...
async def get_history(user_id: str = Depends(get_current_user)):
    ...
    from server.database.db import get_user_history
    try:
...
async def delete_history_entry(
    ...
    from server.database.db import delete_analysis
    try:
...
async def generate_pdf(
    ...
    from server.services.report_generator import generate_html_reports
    from server.services.pdf_export import generate_combined_pdf
