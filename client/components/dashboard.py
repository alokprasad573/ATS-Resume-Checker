...
from client.components.score_display import display_overall_score, display_score_breakdown
from client.components.strengths_issues import display_strengths, display_critical_issues
from client.components.skill_validation import display_skill_validation
from client.components.jd_comparision import display_jd_comparison
from client.components.detailed_feedback import display_detailed_feedback
from client.components.actions_items import display_action_items
from client.components.recommendations import display_recommendations
