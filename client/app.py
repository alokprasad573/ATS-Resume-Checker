...
# Configure page
st.set_page_config(
    page_title="Stackscore | ATS Resume Checker",
    page_icon="🎯",
    layout="wide",
...
if (
    ...
    from client.services import supabase_client
